var store = [{
        ...
        "excerpt":"앱 스토어 심사를 넘겼는데 앱이 심사에서 거부됐다 ㅠ 애플이 리젝 사유를 설명하면서 스크린샷을 같이 줬는데, 술 사진이 올라온 채팅방 캡쳐였다. 이게 뭐가 문젠가 싶어서 검색해보니 대략적으로 신고 기능을 추가해야한다는 얘기였는데, 앱에는 사용자를 개별로 차단할 수 있는 기능이 이미 구현된 상태였다. 이미 우리는 사용자를 차단할 수 있는 기능이 있다는 것을 애플에게...","categories": ["ios","solutions"],
        "tags": [],
